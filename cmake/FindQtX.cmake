...
IF (NOT(${Qt5Widgets_FOUND} AND ${Qt5OpenGL_FOUND} AND ${Qt5Network_FOUND}))
  MESSAGE(FATAL_ERROR "Qt 5 required components have not been found. If they are already installed, "
                      "set CMAKE_PREFIX_PATH variable to locate them.")
ENDIF()
