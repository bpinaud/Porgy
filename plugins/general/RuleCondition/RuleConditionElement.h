...
namespace ConditionParser {
    ...
    typedef boost::variant<
            nil, boost::recursive_wrapper<mini_syntax>, boost::recursive_wrapper<mini_syntax_condition>,
            boost::recursive_wrapper<binary_op>, boost::recursive_wrapper<unary_op>,
            boost::recursive_wrapper<comp_op>, boost::recursive_wrapper<logical_binary_op>,
            boost::recursive_wrapper<logical_unary_op>, boost::recursive_wrapper<not_node_op>, int, double,
            bool, std::string>
            type;
    ...
    struct mini_syntax_condition {
        ...
        explicit mini_syntax_condition(Expr const &expr) : expr(expr) {}
    ...
    struct unary_op {
        ...
        unary_op(char op, mini_syntax_condition subject) : op(op), subject(std::move(subject)) {}
    };
    ...
    struct logical_unary_op {
        ...
        logical_unary_op(char op, mini_syntax_condition subject) : op(op), subject(std::move(subject)) {}
    };
    ...
    struct logical_binary_op {
        ...
        logical_binary_op(std::string op, mini_syntax_condition left,
                          mini_syntax_condition right)
                : op(std::move(op)), left(std::move(left)), right(std::move(right)) {}
    };
...
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::mini_syntax,
                          (std::vector<ConditionParser::mini_syntax_condition>, children))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::mini_syntax_condition, (ConditionParser::type, expr))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::binary_op,
                          (std::string, op)(ConditionParser::mini_syntax_condition,
                                            left)(ConditionParser::mini_syntax_condition, right))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::unary_op,
                          (char, op)(ConditionParser::mini_syntax_condition, subject))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::comp_op,
                          (std::string, op)(ConditionParser::mini_syntax_condition,
                                            left)(ConditionParser::mini_syntax_condition, right))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::logical_unary_op,
                          (char, op)(ConditionParser::mini_syntax_condition, subject))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::logical_binary_op,
                          (std::string, op)(ConditionParser::mini_syntax_condition,
                                            left)(ConditionParser::mini_syntax_condition, right))
BOOST_FUSION_ADAPT_STRUCT(ConditionParser::not_node_op,
                          (std::string, op)(ConditionParser::mini_syntax_condition,
                                            prop_name)(ConditionParser::mini_syntax_condition,
                                                       value_exp))
...
// printer
    struct mini_syntax_printer {
        ...
        mini_syntax_printer(tlp::Graph *g, std::map<std::string, std::string> &lhsNMap,
                            std::map<std::string, std::string> &lhsEMap, tlp::Graph *mdl);
